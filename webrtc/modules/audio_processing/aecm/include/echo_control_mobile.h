...
typedef struct {
    ...
    int16_t echoMode;           // 0, 1, 2, 3 (default), 4 (speaker on)
	int16_t nlpLevel;
	int16_t tailLenMs;
} AecmConfig;
...
int32_t WebRtcAecm_getScaleFactor(void *aecmInst);//added by chgx 20160216

int32_t WebRtcAecm_hasEcho(void* aecmInst);//added by chgx 20160201
int32_t WebRtcAecm_getEchoFarEnRatio(void *aecmInst);//added by chgx 20160323
int32_t WebRtcAecm_getFarFrameDropCnt(void *aecmInst);//added by chgx 20160418

int32_t WebRtcAecm_setPhoneModelName(void *aecmInst,char* name);//added by chgx 20160727
...
int32_t WebRtcAecm_enable_afc(void* aecmInst, int16_t enableAfc);//added by chgx 20170220
/*
 * This function enables the user to set certain parameters on-the-fly
 *
 * Inputs                       Description
