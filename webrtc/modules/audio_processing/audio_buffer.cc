...
void AudioBuffer::DeinterleaveFrom(AudioFrame* frame) {
  //assert(proc_num_frames_ == input_num_frames_);//yangjj modify
  assert(frame->num_channels_ == num_input_channels_);
  //assert(frame->samples_per_channel_ ==  proc_num_frames_);//yangjj modify
  InitForNewData();
...
void AudioBuffer::InterleaveTo(AudioFrame* frame, bool data_changed) const {
  //assert(proc_num_frames_ == output_num_frames_);//yangjj modify
