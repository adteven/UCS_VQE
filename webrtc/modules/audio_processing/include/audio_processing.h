...
#ifndef APM_RECORD_DEBUG
#define APM_RECORD_DEBUG
#endif
...
class AudioProcessing {
 public:
  ...
  virtual int GetReverseStreamLockedScaleFactor() = 0;//added by chgx
  ...
  // For debug 
  virtual void SetPcmRecordPath(const char* pathname) = 0;
...
class EchoControlMobile {
 public:
  ...
  virtual int set_nlp_level(short nlpLevel) = 0;
  virtual short nlp_level() = 0;
  virtual int set_tail_len_ms(short tailLenMs)=0;
  virtual short tail_len_ms() = 0;
  ...
  //added by chgx
  virtual int GetEchoFarEnRatio() = 0;
  virtual int GetScaleFactor() = 0;
  virtual int GetFarFrameDropCnt() = 0;
  virtual int SetPhoneModelName(char*modelName,int len) = 0;
  //end by chgx
